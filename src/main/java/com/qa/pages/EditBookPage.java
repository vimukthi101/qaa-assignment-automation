...
public class EditBookPage extends Controller {
    private static final By EDIT_BOOK_PAGE_TITLE = By.xpath("//h1[@class=\"page-header\"]");
    ...
    public String getPageTitle() {
        return getTextFromElement(EDIT_BOOK_PAGE_TITLE);
    }

    public String getTitle() {
        return getTextFromElement(TITLE_INPUT);
    }

    public String getYear() {
        return getTextFromElement(YEAR_INPUT);
    }

    public EditBookPage inputTitle(String title) {
        typeText(TITLE_INPUT, title);
        return this;
    }

    public EditBookPage inputYear(String year) {
        typeText(YEAR_INPUT, year);
        return this;
    }

    public EditBookPage clickSaveButton() {
        clickElement(SAVE_BUTTON);
        return this;
    }

    public EditBookPage clickClearButton() {
